...
use COMPRASWEB;
create table cliente (nif varchar(9), nombre varchar(40), apellido varchar(40), cp varchar(5), direccion varchar(40), ciudad varchar(40));
alter table cliente add constraint pk_cliente primary key (nif); 
create table categoria (id_categoria varchar(5), nombre varchar(40));
alter table categoria add constraint pk_categoria primary key (id_categoria); 
create table almacen (num_almacen integer, localidad varchar(40)); 
...
create table almacena (num_almacen integer, id_producto varchar(5), cantidad integer);
